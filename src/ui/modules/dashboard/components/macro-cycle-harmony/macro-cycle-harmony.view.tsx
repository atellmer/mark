...
import { bitcoinMacroCycleHarmony } from '@core/trading/indicators/bitcoin-macro-cycle-harmony';
...
export type MacroCycleHarmonyProps = {};

const MacroCycleHarmony: React.FC<MacroCycleHarmonyProps> = props => {
	const { theme } = useTheme();
	const bars = useMemo(() => Bar.fromJSON(pricesdataset), []);
	const { values, topTrendline } = bitcoinMacroCycleHarmony(bars);
